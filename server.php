...
if (isset($_POST['sign'])) { 
	...
	$password_2 = mysqli_real_escape_string($db, $_POST['pswd1']); 
	...
	if (count($errors) == 0) { 
		...
		$query = "INSERT INTO signup(name, email, phone, username, newpass, confpass)VALUES('$name','$email','$phone','$username','$password_1','$password_2')";
